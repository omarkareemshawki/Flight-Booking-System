...
public class AdminLoginGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UsernameLable1.setText("Welcome to the controlling system");
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        if (validation()) {
            ...
            Admin admin = new Admin("", 0, UsernameTextField.getText(), PasswordField.getText());
            try {
                if (admin.login(UsernameTextField.getText(), PasswordField.getText())) {
